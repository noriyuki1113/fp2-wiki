...
- 新規作成：questions/g2_202505.md（2025年5月公表サンプル 60問）
- 新規作成：topics/fp_ethics_law.md（FP業務と関連法規）
- 新規作成：topics/nenkin_hikiage_sagari.md（老齢年金の繰上げ・繰下げ）
- 新規作成：topics/seiho_shouhin.md（生命保険の商品性）
- 新規作成：topics/seiho_ryokin_kojyo.md（生命保険料控除）
- 新規作成：topics/hojin_seiho_keiri.md（法人保険の経理処理）
- 新規作成：topics/jishin_hoken.md（地震保険・火災保険）
- 新規作成：topics/son_eki_tsukan.md（損益通算）
- 新規作成：topics/shoukibo_takuchi.md（小規模宅地等の特例）
- 新規作成：topics/saiken_rimawari.md（債券の利回り計算）
- 新規作成：topics/portfolio_kitai_rimawari.md（ポートフォリオ理論と期待収益率）
- 更新：fields/ 全6ファイルに関連論点リンクを追記
- 更新：wiki/index.md に全新規ページを追記
- 両試験共通テーマ9件を特定（questions/g2_202505.md末尾に記録）

## [2026-04-10] init | wiki初期構築
- ディレクトリ構成を作成
- fields/ 各分野ページを初期化
- index.md・log.md・schema/templates.md を作成
